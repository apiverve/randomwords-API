...
```gradle
dependencies {
    implementation 'com.github.apiverve:randomwords-api:1.1.12'
}
```
...
```java
import com.apiverve.randomwords.RandomWordAPIClient;
import com.apiverve.randomwords.APIResponse;
import com.apiverve.randomwords.APIException;

// Initialize the client
RandomWordAPIClient client = new RandomWordAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/randomwords](https://docs.apiverve.com/ref/randomwords)
...
- **Documentation:** [https://docs.apiverve.com/ref/randomwords](https://docs.apiverve.com/ref/randomwords)
- **Issues:** [GitHub Issues](https://github.com/apiverve/randomwords-api/issues)
