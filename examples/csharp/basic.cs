/*
 * Random Word API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Random Word API.
 * API Documentation: https://docs.apiverve.com/ref/randomwords
 */
...
namespace APIVerve.Examples
{
    class RandomWordExample
    {
        ...
        {
            Console.WriteLine("📤 Calling Random Word API...\n");

            var result = await CallRandomWordAPI();
