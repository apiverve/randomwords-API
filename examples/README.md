# Random Word API - Examples

This folder contains example code for using the Random Word API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/randomwords',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/randomwords");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/randomwords](https://docs.apiverve.com/ref/randomwords)
